...
export class ReportsController {
  ...
  sales(
    ...
    return this.reportsService.sales({ companyId, from, to, groupBy });
  }
  ...
  inventory(@Query('warehouseId') warehouseId?: string, @Query('companyId') companyId?: string) {
    return this.reportsService.inventory({ warehouseId, companyId });
  }
  ...
  margin(
    ...
    return this.reportsService.margin({ companyId, from, to });
  }
